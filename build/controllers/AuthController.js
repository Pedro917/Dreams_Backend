...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.auth = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, user, isValidPassword, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        token = jsonwebtoken_1.default.sign({ id: user.id }, process.env.SECRET_KEY, { expiresIn: '5d' });
                        delete user.password;
                        return [2 /*return*/, res.status(202).json({ user: user, token: token })];
                }
            });
        });
    };
